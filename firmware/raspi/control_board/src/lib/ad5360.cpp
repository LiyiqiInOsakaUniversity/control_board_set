...
{
  //printf("AD5360: Using GPIO %d, Channel %d, Group %d for setting voltage of %f", cs, channel, group, voltage);
...
{
  //printf("AD5360: Using GPIO %d, Channel %d, Group %d for setting normalized value of %f", cs, channel, group, value);
  buildDataCommandHeader(group, channel);
...
{
  //printf("AD5360: Using GPIO %d, Channel %d, Group %d for setting gain of %d", cs, channel, group, gain);
...
{
  //printf("AD5360: Using GPIO %d, Channel %d, Group %d for setting offset of %d", cs, channel, group, offset);
...
{
  //printf("AD5360: Resetting %d, Channel %d, Group %d to 0.0V", cs, channel, group);
